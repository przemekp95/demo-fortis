    ...
    <div class="min-h-screen bg-slate-950 text-slate-100">
        <header class="border-b border-white/10 bg-slate-950/80">
            <div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-5 sm:px-6 lg:px-8">
                <div>
                    ...
                    <h1 class="mt-1 text-xl font-semibold text-white">Regulamin loterii paragonowej</h1>
                </div>
        ...
        <main class="mx-auto flex max-w-5xl flex-col gap-6 px-4 py-8 sm:px-6 lg:px-8">
            <section class="rounded-3xl border border-white/15 bg-slate-900/70 p-6 sm:p-8">
                <p class="text-sm text-slate-300">Wersja regulaminu: 1.0 | Data obowiązywania: 27 lutego 2026</p>
                <p class="mt-4 leading-relaxed text-slate-200">
                    Niniejszy regulamin określa warunki uczestnictwa w loterii paragonowej organizowanej przez
                    markę Fortis w serwisie internetowym i aplikacji PWA.
                </p>
            </section>
            ...
            <section class="rounded-3xl border border-white/15 bg-slate-900/70 p-6 sm:p-8">
                ...
                <p class="mt-3 leading-relaxed text-slate-200">
                    Organizatorem loterii jest Fortis Sp. z o.o. Uczestnik to osoba fizyczna, która założyła konto,
                    potwierdziła adres e-mail i zaakceptowała wymagane zgody.
                </p>
            </section>
            ...
            <section class="rounded-3xl border border-white/15 bg-slate-900/70 p-6 sm:p-8">
                ...
                <p class="mt-3 leading-relaxed text-slate-200">
                    Loteria trwa w terminach opublikowanych na stronie głównej kampanii. Udział możliwy jest na
            ...
            <section class="rounded-3xl border border-white/15 bg-slate-900/70 p-6 sm:p-8">
                <h2 class="text-xl font-semibold text-white">6. Weryfikacja i utrata prawa do nagrody</h2>
                <p class="mt-3 leading-relaxed text-slate-200">
                    Organizator może żądać okazania oryginału paragonu i dodatkowych danych potwierdzających.
                    Brak współpracy, podanie nieprawdziwych danych lub stwierdzenie nadużycia skutkuje utratą
                    prawa do nagrody.
                </p>
            </section>
            ...
            <section class="rounded-3xl border border-white/15 bg-slate-900/70 p-6 sm:p-8">
                ...
                <p class="mt-3 leading-relaxed text-slate-200">
                    ...
                    <a href="mailto:reklamacje@fortis.test" class="text-cyan-200 hover:text-cyan-100">reklamacje@fortis.test</a>
            ...
            <section class="rounded-3xl border border-white/15 bg-slate-900/70 p-6 sm:p-8">
                ...
                <p class="mt-3 leading-relaxed text-slate-200">
                    Organizator zastrzega możliwość aktualizacji regulaminu z ważnych przyczyn prawnych
                    lub organizacyjnych. Aktualna wersja jest publikowana pod tym adresem.
                </p>
            </section>
